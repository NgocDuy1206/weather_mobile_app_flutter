...
class MyColors {
  ...
  static const Color background_theme_white = Color(0xFFFFFFFF);
  static const Color background_theme = Color(0xFFFFFFFF);
  static const Color background_theme_black = Color(0xFF2F2C2C);
